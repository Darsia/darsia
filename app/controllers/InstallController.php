...
class InstallController extends \yii\web\Controller
{
    ...
    public function insertTexts()
    {
        ...
        (new Text([
            'text' => 'Добро пожаловать в интернет-магазин Dream',
    ...
    public function insertPages()
    {
        ...
        $page1 = new Page([
            'title' => 'Index',
            'text' => '<p><strong>Здесь платья</strong>&nbsp;</p><p>Dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.&nbsp;Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>',
            'slug' => 'page-index'
        ]);
        $page1->save();
